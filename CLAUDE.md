...
- Python 3.11+ (Backend), TypeScript 5.3+ (Frontend) + FastAPI 0.109+, SQLAlchemy 2.0+, Pydantic 2.0+, React 18+, Zustand (013-tts-role-mgmt)
- PostgreSQL (voice_customization 表), 關聯現有 VoiceCache 表 (013-tts-role-mgmt)
...
## Recent Changes
- 013-tts-role-mgmt: Added Python 3.11+ (Backend), TypeScript 5.3+ (Frontend) + FastAPI 0.109+, SQLAlchemy 2.0+, Pydantic 2.0+, React 18+, Zustand
