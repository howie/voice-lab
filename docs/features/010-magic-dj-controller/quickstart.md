...
|------|---------|------|------|
| 1 | 開場白 | Voice | 小怪獸自我介紹 |
| 2 | 收玩具歌 | Music | 巧虎式洗腦神曲（循環播放） |
| 3 | 成功獎勵 | SFX | 跑道淨空成功音效 |
| 4 | 魔法書過場 | Music | 智慧圖書館介紹 |
| 5 | 迷霧森林 | Music | 迷霧森林兩條路 |
| F | 思考音效 | SFX | 魔法運轉聲 |
| W | 等待填補 | Voice (rescue) | 訊號不好，等等喔 |
| E | 緊急結束 | Voice (rescue) | 天黑了，我們該回家了 |
